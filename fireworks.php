...
<body>
	...
	<b style="font-size: 50px;">Happy Valentines Day</b><br><br><br><br><br><br><br><br><br><br><br><br>
	<br><br><br><br><br><br><br><br><br><br><br><br>
	  <a href="index.php"><button class="button button3" id="destroyFireworks">Calculate</button></a>
...
$(document).ready(function() {
	setTimeout(myURL, 20000);
         function myURL(){
            ...
            // window.load('http://localhost/cva/','index.php');
         }
